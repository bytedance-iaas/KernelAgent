# Skill: Extract Subgraphs from Fused Code
...
## When to Use
After `01_fuse_model.md` has produced verified fused code, to decompose it into
...
```bash
python skillset/tools/dedup_subgraphs.py --input $RAW_JSON_PATH --output $RUN_DIR/subgraphs.json
```
