# Step: Compose End-to-End Kernel
...
```bash
python "${CLAUDE_SKILL_DIR}/tools/run_candidate.py" --code-path $COMPOSED_PATH --timeout 120
```
...
**Refinement guidance:**
- Fix language compilation/runtime errors using the language-specific pitfalls
  listed in `${CLAUDE_SKILL_DIR}/steps/04_refine_kernel.md`
