...
- `OUTPUT_PATH` (optional): where to write the problem file (default: next
  to the source, named per the KernelBench convention).
...
validation verdict, equivalence verdict.
