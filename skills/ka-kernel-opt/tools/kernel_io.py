...
def load_problem(problem_path: str | Path, workload_index: int | None = None):
    ...
    build that specific workload instead of the canonical one. Used for
    per-workload niching (direction 3) and lazy niche scan: benchmarking a
    candidate against several representative workloads, not just the
    round's single proxy.
